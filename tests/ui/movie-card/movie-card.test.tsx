...
describe('MovieCard component', () => {
  ...
  it('renders no tagline', async () => {
    render(
      <MovieCard movie={mockMovie({ tagline: undefined })} compact={false} />
    )
  ...
  it('renders no overview', async () => {
    render(
      <MovieCard movie={mockMovie({ overview: undefined })} compact={false} />
    )
  ...
  it('renders no link to movie website', async () => {
    render(
      <MovieCard movie={mockMovie({ homepage: undefined })} compact={false} />
    )
    expect(
  ...
  it('renders a link to movie website', async () => {
    ...
    expect(screen.getByText('Lien vers le site du film')).toHaveAttribute(
      'href',
      'http://www.super-movie.com'
    )
  })

  it('renders no link to movie page on IMDB', async () => {
    render(
      <MovieCard movie={mockMovie({ imdbId: undefined })} compact={false} />
    )
    expect(
      screen.queryByText('Lien vers la page IMDB du film')
    ).not.toBeInTheDocument()
  })
  ...
  it('renders a link to movie page on IMDB', async () => {
    render(<MovieCard movie={mockMovie()} compact={false} />)
    expect(
      screen.getByText('Lien vers la page IMDB du film')
    ).toBeInTheDocument()
  ...
  it('renders in compact mode', async () => {
    const { container } = render(
      <MovieCard movie={mockMovie()} compact={true} />
    )
    expect(
      screen.queryByText('Lien vers la page IMDB du film')
    ).not.toBeInTheDocument()
