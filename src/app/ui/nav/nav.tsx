...
export default function Nav({ enableButton }: { enableButton: boolean }) {
  return (
    <nav className="flex w-full items-center gap-3 bg-zinc-300 dark:bg-zinc-800">
      <Image src={Logo} width={50} alt="logo" color="gray" className="logo ml-2 dark:invert" priority />
      ...
      {enableButton && (
        ...
        >
          <Image src={MovieIcon} width={24} alt="logo" color="gray" className="logo ml-2 dark:invert" priority />
          Retour à la liste
        </Link>
      )}
